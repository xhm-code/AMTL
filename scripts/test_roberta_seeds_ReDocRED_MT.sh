...
do
  ...
  do
    ...
    python train.py \
        ...
        --seed ${SEED} \
        --loss_type ${loss_type} \
        --save_name "redocred_roberta_${loss_type_num}_${num_train_epochs}epoch_${learning_rate}_seed${SEED}" \
        --load_path "./checkpoint/redocred_roberta_${loss_type_num}_${num_train_epochs}epoch_${learning_rate}_seed${SEED}.pt" \
        --cuda_device 0 \
        --num_class ${num_class} \
